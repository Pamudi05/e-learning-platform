...
router.post('/create',upload.array('image',1) , authMiddleware.verifyToken,authMiddleware.adminOnly, courseController.createCourse);
...
router.put('/update/:id',upload.array('image', 1), authMiddleware.verifyToken, authMiddleware.adminOnly, courseController.update);
